				...
				<div class="banner">
					<div class="container">
						<div class="image-wrap">
							<img class="category-image" src="${pageContext.request.contextPath}/assets/img/기업일반.jpg">
						</div>
				...
				<aside class="side-bar">
					<div class="sidebar-desktop">
						...
						<!-- 메인페이지  a태그 -->
							...
							<li>
								<a  class="choice " href="http://localhost:9000/kovengerss/category6.jsp">기업일반</a>
							</li>
							<li>
